...
public class ArmExercise : ExerciseData
{
    float iu;
    public override void Start()
    {
        ...
        _playerUpgrades = FindObjectOfType<ArmExercisesUpgrade>(true);

        _playerSkins = FindObjectOfType<StrawberrySkin>(true);
    ...
    private void Update()
    {
        ...
        //    DoExercise();
        //}
        //else if (PlayerInputHandler._isJoystickTouch == true && _isPlayerNear == true && _isExerciseOnPause == false)
        //{
        ...
        //if (PlayerInputHandler._isJoystickTouch == true && _isPlayerNear == true && _isExerciseOnPause == false)
        //{
        //    _eventBus.OnExerciseInterrupted?.Invoke();
    ...
    public override void DoExercise()
    {
        ...
        if (_exerciseExecutionProgress >= _exerciseExecutionTime)
        {
            ...
            //_addStrengthEventHandler.AddStrengthEventhandler("Arm exercise", (int)_addedStrenghtValue);
        ...
        if (_isPlayerNear)
        {
            if (_exerciseExecutionProgress >= _exerciseExecutionTime)
            {
                if (_exerciseTry == 1)
                {
                    ...
                    _addStrengthEventHandler.AddStrengthEventhandler("Arm exercise", Mathf.RoundToInt(_addedStrenghtValue * _bonusCoefficient));
                ...
                else
                {
                    ...
                    _addStrengthEventHandler.AddStrengthEventhandler("Arm exercise", Mathf.RoundToInt(_currentStrengthValue));
            ...
            else
            {
                ...
                _addStrengthEventHandler.AddStrengthEventhandler("Arm exercise", Mathf.RoundToInt(_currentStrengthValue * (_exerciseExecutionProgress / _exerciseExecutionTime)));
                ...
                //_currentWaterValue = _currentWaterValue * (1 - (_exerciseExecutionProgress / _exerciseExecutionTime));
